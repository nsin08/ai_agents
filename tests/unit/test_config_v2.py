...
""")
        ...
        config = AgentConfig.from_yaml(yaml_file, models={"provider": "openai", "model": "gpt-4"})
    ...
    def test_explicit_overrides_env(self, monkeypatch):
        ...
        config = AgentConfig.from_env(app={"name": "explicit_agent"}, engine={"max_turns": 20})
...
""")
        ...
        config = AgentConfig.from_yaml(yaml_file, app={"name": "explicit_agent"})
...
class TestConfigSections:
    ...
    def test_app_section(self):
        ...
        config = AgentConfig(
            app={"name": "test_app", "mode": "production", "debug": False, "log_level": "INFO"}
        )
    ...
    def test_memory_section(self):
        ...
        config = AgentConfig(
            memory={"short_term_size": 20, "long_term_enabled": True, "context_window": 8192}
        )
    ...
    def test_engine_section(self):
        ...
        config = AgentConfig(engine={"max_turns": 20, "timeout": 600, "enable_reflection": False})
...
class TestConfigExport:
    ...
    def test_to_dict(self):
        ...
        config = AgentConfig(app={"name": "test_agent"}, models={"provider": "mock"})
