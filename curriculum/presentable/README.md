# AI Agents Learning Curriculum (Presentable Pack)

This folder contains a presentation-ready curriculum built from the rough draft at `../ai_agents_learning_curriculum.md`.
...
- Projects (12 total)
  ...
  - `projects/P02_intent_router.md`
  - `projects/P03_support_agent_read_only.md`
  - `projects/P04_multi_tool_orchestrator.md`
  - `projects/P05_rag_with_evaluation.md`
