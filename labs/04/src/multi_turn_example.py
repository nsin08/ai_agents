...
def run_conversation() -> None:
    ...
    agent.retrieve("weather location Seattle", include_trace=True)
    print(f"User: {user_msg}")
    ...
    agent.retrieve("activities hiking Seattle weekend", include_trace=True)
    print(f"User: {user_msg}")
    agent_response = (
    ...
    agent.retrieve("restaurant vegetarian Seattle", include_trace=True)
    print(f"User: {user_msg}")
    agent_response = (
    ...
    print("\nMemory Statistics:")
    print(
        f"  Short-term: {stats['short_term_count']}/{stats['short_term_max']} items "
    ...
    print(
        f"Loaded agent - Short-term: {loaded_stats['short_term_count']}, "
